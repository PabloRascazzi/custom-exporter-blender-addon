OpenGL Exporter Version 0.7.4 (Additional Information)

Patch Notes:
 - Changed Quaternion format from [x,y,z,w] to [w,x,y,z]
 - Added ExportContext class
 - Modified all existing code to use the ExportContext instead of a lot of function parameters
